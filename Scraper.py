...
driver = webdriver.Chrome(executable_path=chromedriver_path) #Open Chrome
sleep(2)

# kayak = 'https://www.kayak.com/flights/LIS-SIN/2020-07-29-flexible/2020-08-15-flexible?sort=bestflight_a'
# driver.get(kayak)
# sleep(3)


#Click the load_more button in the page
def load_more():
    try:
...
def start_kayak(city_from, city_to, date_start, date_end):
    ...
    # sometimes a popup, such as ads, shows up, so we can use a try statement to check it and close
    print('try to close popup')
    try:
        xp_popup_close = '//button[contains(@id,"dialog-close") and contains(@class,"Button-No-Standard-Style close ")]'
        # driver.find_elements_by_xpath(xp_popup_close)
        driver.find_elements_by_xpath(xp_popup_close)[7].click() #The seventh is for closing the covid alert.
...
start_kayak(start_kayak(city_from, city_to, date_start, date_end))
# for n in range(0, 5):
